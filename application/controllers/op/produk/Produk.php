...
class Produk extends CI_Controller {
	...
	function add()
	{
		...
		if($this->form_validation->run()==TRUE)
		{
			...
			$photo='upload';
			if($this->mod_produk->produk_add_single($kode,$nama,$merek,$kategori,$deskripsi,$harga,$photo)==TRUE)
			{
	...
	function edit()
	{
		...
		if($this->form_validation->run()==TRUE)
		{
			...
			$deskripsi=$this->input->post('deskripsi',TRUE);
			$photo='upload';
			if($this->mod_produk->produk_edit($produkid,$kode,$nama,$merek,$kategori,$deskripsi,$harga,$photo)==TRUE)
			{				
