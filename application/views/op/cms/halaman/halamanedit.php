...
<div class="col-md-8">
	<div class="form-group">
		<input type="text" name="judul" class="form-control" required="" placeholder="Judul Halaman" value="<?=set_value('judul',$row->judul);?>"/>
	</div>
	<div class="form-group">
		<textarea name="isi" class="form-control" id="isi" required="" placeholder="Isi Halaman"><?=set_value('isi',$row->isi);?></textarea>
	</div>
	<script>
