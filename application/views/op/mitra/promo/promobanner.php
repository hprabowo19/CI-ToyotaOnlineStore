...
echo form_open_multipart(base_url(akses().'/mitra/promo/gambar'),array('class'=>'form-horizontal'));
?>
...
<div class="form-group">
	...
	<div class="col-md-10">
		...
		<a href="<?=$urlOK;?>" target="_blank">
			...
			<a href="<?=base_url(akses().'/mitra/promo/deletebanner').'?id='.$row->promo_id;?>" class="btn btn-danger btn-lg">Hapus Banner</a>
		</a>
		<?php	
		}else{					
		?>
