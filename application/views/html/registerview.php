...
<div class="form-group required">
	...
	<div class="col-md-6">
		<textarea name="alamat" required="" class="form-control" placeholder="Alamat"><?=set_value('alamat');?></textarea>
	</div>
</div>
<div class="form-group required">
...
<div class="form-group required">
	<label class="col-sm-2 control-label" for="">Pertanyaan</label>
	<div class="col-md-6">
		<textarea name="tanya" required="" class="form-control" placeholder="Pertanyaan"><?=set_value('tanya');?></textarea>
	</div>
</div>
<div class="form-group required">
