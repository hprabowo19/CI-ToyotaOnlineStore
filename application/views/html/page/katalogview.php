...
if(!empty($dTerbaru))
{
		foreach($dTerbaru as $rBaru)
		{
			...
			$urlPhotoBaru=base_url().'assets/images/produk/thumbs/200/'.$rPhotoBaru->photo;
			$pathPhotoBaru=FCPATH.'assets/images/produk/thumbs/200/'.$rPhotoBaru->photo;
		...
		?>
		<div class="col-sm-4 col-sm-4 hero-feature text-center">
        <div class="thumbnail">
        	<a href="<?=$urlProdukBaru;?>" class="link-p">
            	<img src="<?=$urlPhotoBaru;?>" alt="">
        	</a>
            <div class="caption prod-caption">
                <a href="<?=$urlProdukBaru;?>"><?=$rBaru->nama_produk;?></a>
                <p>
                	<div class="btn-group">
                    	<a href="javascript:;" class="btn btn-default">Rp <?=number_format($rBaru->harga,0);?></a>
                    	<a href="<?=base_url();?>produk/add/<?=$rBaru->produk_id;?>" class="btn btn-primary"><i class="fa fa-eye"></i> Lihat Tipe</a>
                	</div>
                </p>
            </div>
        </div>
