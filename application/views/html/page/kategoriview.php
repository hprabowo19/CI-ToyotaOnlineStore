...
if(!empty($dKategoriTerbaru))
{
		foreach($dKategoriTerbaru as $rKategori)
		{
			...
			$urlPhotoKategori=base_url().'assets/images/produk/thumbs/200/'.$rPhotoKategori->photo;
			$pathPhotoKategori=FCPATH.'assets/images/produk/thumbs/200/'.$rPhotoKategori->photo;
		...
		?>
		<div class="col-md-3 col-sm-3 hero-feature text-center">
        <div class="thumbnail">
            ...
            <div class="caption prod-caption">
                ...
                <p>
                	<div class="btn-group">
                    	...
                    	<a href="<?=base_url();?>produk/add/<?=$rKategori->produk_id;?>" class="btn btn-primary"><i class="fa fa-eye"></i> Lihat Tipe</a>
                	</div>
                </p>
            </div>
        </div>
