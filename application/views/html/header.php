	    ...
	    <div class="container">
	        <div class="row">
	            ...
	            <div class="col-lg-4 col-md-3 hidden-sm hidden-xs">
	            	<div class="well logo">
	            		<a href="<?=base_url();?>">
	            			<span><?=baca_konfig('company-name');?></span> <?=baca_konfig('nama-aplikasi');?>
	            		</a>	            		
	            	</div>
	            </div>
	            <!-- End Logo -->
	            	...
	            	<div class="well">
	                    <form action="<?=base_url();?>produk/cari" method="get">
	                        <div class="input-group">
	                            <input type="text" name="cari" class="form-control input-search" placeholder="Cari Mobil Toyota"/>
	            ...
	            <div class="col-lg-3 col-md-4 col-sm-5">
	                <div class="well">
						...
						<a href="<?=base_url();?>member/daftar?ref=<?=$ref;?>">Contact Us</a>
						<?php
						}
	                    ?>						
	                    </div>
    ...
    <nav class="navbar navbar-inverse hidden-print" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand visible-xs" href="<?=base_url();?>">Toyota Online Store</a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">                	
                    <li><a href="<?=base_url();?>">Home</a></li>
                    <li><a href="<?=base_url();?>katalog" class="<?=menu_html('katalog');?>">Katalog</a></li>                    
                    <li><a href="<?=base_url();?>member/daftar" class="<?=menu_html('member');?>">Contact Us</a></li>
