...
<div class="col-md-9">
	...
	<div class="form-group">
		...
		<div class="col-md-6">
			<input type="text" name="nama" id="nama" class="form-control" autocomplete="off" placeholder="Entri Nama Lengkap Baru" required="" value="<?=user_info('nama');?>"/>
		</div>
	</div>	
	<div class="form-group">
		<label class="col-sm-2 control-label" for="password">Password</label>
		<div class="col-md-6">
			<input type="password" name="password" id="password" class="form-control" autocomplete="off" placeholder="Entri Password Baru"/>
		</div>
	</div>
	<div class="form-group">
