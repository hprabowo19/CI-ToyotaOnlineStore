...
class Produk_model extends CI_Model
{
	...
	function promo_data($where=array(),$order="promo_id ASC")
	{
	...
	function produk_add_single($kode,$nama,$merekID,$kategoriID,$deskripsi,$harga,$photo='')
	{		
		$d=array(
		'kode_produk'=>$kode,
		'nama_produk'=>$nama,
		...
		if($this->m_db->add_row('produk',$d)==TRUE)
		{
			...
			// $this->produk_add_stok_single($produkID);
			if(!empty($photo))
			{
	...
	function produk_edit($produkID,$kode,$nama,$merekID,$kategoriID,$deskripsi,$harga,$photo='')
	{
		$s=array(
		'produk_id'=>$produkID,
		);
